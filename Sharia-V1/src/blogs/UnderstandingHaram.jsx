...
import { ChevronDown, ChevronUp, Book, DollarSign, Filter, Shield, Users, HelpCircle, Home, Briefcase, List } from 'lucide-react';
...
function UnderstandingHaram() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      {/* Main Content */}
      <main className=" mx-auto px-4 md:px-8 py-12">
