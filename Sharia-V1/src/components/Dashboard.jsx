              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="p-6">
                    ...
                    {[
                      ...
                      <div key={index} className="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div className={`px-2 py-1 rounded-full text-xs ${item.trend === 'up' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}>
                            {item.change}
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <div className="text-sm text-gray-500">Last updated: Today, 3:30 PM IST</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { title: 'Watchlist', icon: 'eye', action: () => navigate('/watchlist') },
                      { title: 'Notifications', icon: 'pie-chart', action: () => navigate('/notification') },
                      // { title: 'Screener', icon: 'filter', action: () => navigate('/screener') },
                      { title: 'Get Premium', icon: 'star', action: () => navigate('/subscriptiondetails') }
                    ].map((item, index) => (
                      <button 
                        key={index} 
